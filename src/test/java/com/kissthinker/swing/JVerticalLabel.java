...
public class JVerticalLabel extends JLabel
{
    ...
    public java.awt.Dimension getPreferredSize()
    {
        ...
        String text = getText();
        int h = fm.stringWidth(text), descent = fm.getDescent(), ascent = fm.getAscent();
        return new java.awt.Dimension(ins.top + ascent + descent + ins.bottom, ins.right + h + ins.left);
    }
    ...
    public void paint(java.awt.Graphics g)
    {
        ...
        int descent = fm.getDescent(), ascent = fm.getAscent(), y = ins.top + ascent;
